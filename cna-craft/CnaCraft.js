...
(function() {
  ...
  if (typeof process !== 'undefined' && !process.versions?.bun && typeof Deno == "undefined") {
    ...
    if (currentNodeVersion < 241500) {
      throw new Error(`This emscripten-generated code requires node v${ packedVersionToHumanReadable(241500) } (detected v${packedVersionToHumanReadable(currentNodeVersion)})`);
    }
  }
...
// include: /rv/data/development/github.com/openeggbert/cna-craft/web/pre.js
...
// end include: /rv/data/development/github.com/openeggbert/cna-craft/web/pre.js
...
function findWasmBinary() {
  return locateFile('CnaCraft.wasm');
}
...
function assignWasmExports(wasmExports) {
  ...
  _cna_read_module_preferred_renderer = Module['_cna_read_module_preferred_renderer'] = createExportWrapper('cna_read_module_preferred_renderer', wasmExports['cna_read_module_preferred_renderer'], 0);
  _cna_set_preferred_renderer = Module['_cna_set_preferred_renderer'] = createExportWrapper('cna_set_preferred_renderer', wasmExports['cna_set_preferred_renderer'], 1);
